...
export const KEY_CONFIG: KeyConfig = {
  ...BARE_KEYS,
  Q: { ...BARE_KEYS.Q, label: '🎷', name: "Chase", soundUrl: '/sounds/yakity-yak.ogg' },
  R: { ...BARE_KEYS.R, label: '🚨', name: "Airhorn", soundUrl: '/sounds/airhorn.ogg' },
  T: { ...BARE_KEYS.T, label: '👩‍🎤', name: "Shade", soundUrl: '/sounds/shade.ogg' },
  Y: { ...BARE_KEYS.Y, label: '🛎️', name: "Ding", soundUrl: '/sounds/ding.ogg' },
  U: { ...BARE_KEYS.U, label: '🙊', name: "Uhoh", soundUrl: '/sounds/uhoh.ogg' },
  I: { ...BARE_KEYS.I, label: '🙀', name: "Dun-Dun-Dunnn", soundUrl: '/sounds/dun-dun-dunnn.ogg' },
  A: { ...BARE_KEYS.A, label: '🍎', name: "Macbook", soundUrl: '/sounds/mac.ogg' },
  S: { ...BARE_KEYS.S, label: '🌀', name: "Boing", soundUrl: '/sounds/boing.ogg' },
  F: { ...BARE_KEYS.F, label: '😕', name: "Wah-Wah-Wahhh", soundUrl: '/sounds/wah-wah-wahhh.ogg' },

  J: { ...BARE_KEYS.J, label: '👏', name: "Applause", soundUrl: '/sounds/light-applause.ogg', hidden: true },
  K: { ...BARE_KEYS.K, label: '🤭', name: "Small laugh", soundUrl: '/sounds/dad-joke.ogg' },
  L: { ...BARE_KEYS.L, label: '😂', name: "Big Laugh", soundUrl: '/sounds/big-laugh.ogg' },

  Z: { ...BARE_KEYS.Z, label: '😱', name: "Scary (strings)", soundUrl: '/sounds/scary.ogg' },
  X: { ...BARE_KEYS.X, label: '🤡', name: "Clown Horn", soundUrl: '/sounds/clown-horn.ogg' },
  C: { ...BARE_KEYS.C, label: '📺', name: "Are Your My People?", soundUrl: '/sounds/chant.ogg' },
  V: { ...BARE_KEYS.V, label: '⏳', name: "Jeopardy", soundUrl: '/sounds/jeopardy.ogg' },
  N: { ...BARE_KEYS.N, label: '🔥', name: "Dolly Parton", soundUrl: '/sounds/burnin.ogg' },
  M: { ...BARE_KEYS.M, label: '💾', name: "Restaging music",soundUrl: '/sounds/copy.ogg' },
  Space: {
    ...BARE_KEYS.Space,
    label: '💋',
    name: "Theme Song",
