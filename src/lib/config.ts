...
export const KEY_CONFIG: KeyConfig = {
  ...
  R: { ...BARE_KEYS.R, label: '🚨', soundUrl: '/sounds/airhorn.ogg' },
  ...
  A: { ...BARE_KEYS.A, label: '🍎', soundUrl: '/sounds/mac.ogg' },
  S: { ...BARE_KEYS.S, label: '🌀', soundUrl: '/sounds/boing.ogg' },
  F: { ...BARE_KEYS.F, label: '😕', soundUrl: '/sounds/wah-wah-wahhh.ogg' },

  J: { ...BARE_KEYS.J, label: '👏', soundUrl: '/sounds/light-applause.ogg', hidden: true },
  ...
  C: { ...BARE_KEYS.C, label: '📺', soundUrl: '/sounds/chant.ogg' },
